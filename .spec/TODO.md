...
- [x] T011: 隙間バグ調査・対応 — 2026-08-17 (v1.6.7〜v1.7.3)
  ...
  - [ ] 残課題: ゲーム内隙間が完全には消えていない — ① DCR 有効確認 (ユーザー側, GIMI Issue #364) ② フィールド = box 境界の段差対策 (顎が box 縁付近) ③ UI 画面 = 頭部回転ドリフト + カットシーン用第 2 ハッシュ + diffuse ガード
