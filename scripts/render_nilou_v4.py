...
OBJ_DIR = r"D:\Documents\Default Project\Nilou\anime_nilou_v4\Mesh"
OUT_DIR = r"D:\Documents\Default Project\Nilou\render_test_v4"
os.makedirs(OUT_DIR, exist_ok=True)

HEAD_SCALE = float(sys.argv[sys.argv.index('--') + 1]) if '--' in sys.argv and len(sys.argv) > sys.argv.index('--') + 1 else 0.65

HEAD_PREFIXES = ('Face', 'Brow', 'EyeStar', 'EffectMesh', 'EffectHair')
EXCLUDE_PREFIXES = ('Area_', 'Property_', 'DeathZone', 'AvatarObj_', 'Build_', 'Common_', 'NPC_', 'Ani_', 'SceneObj_', 'Stages_', 'MapObj_')

# Whitelist: only these 17 character meshes load (filter 524 OBJs down to Nilou char)
CHAR_MESH_WHITELIST = {
    'Body', 'Body_LOD1', 'Body_LOD2', 'Body_LOD3',
    'Face', 'Face02', 'Face_Eye', 'Face_Eye_LOD2', 'Face_Eye_LOD3', 'Face_LOD2', 'Face_LOD3',
    'Brow', 'Brow_LOD2', 'Brow_LOD3',
    'EyeStar', 'EffectMesh', 'EffectHair',
}
